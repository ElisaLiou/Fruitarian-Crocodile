 ...
 * @version 1.0
 */
public class Game3Scene extends BaseScene implements IOnMenuItemClickListener
{
...
//		playMenuItem.setPosition(playMenuItem.getX(), playMenuItem.getY() + 10);
		ROPEItem.setPosition(-155, ROPEItem.getY()+80);
		BOLLONItem.setPosition(50,300);
				...
				else if (type.equals(TAG_ENTITY_ATTRIBUTE_TYPE_VALUE_PLAYER))
				{
					player = new Player(x,y, vbom, camera, physicsWorld)
					{
						...
						public void onDie()
						{
							...
							{
								displayGameOverText();
								engine.registerUpdateHandler(new TimerHandler(4.8f, new ITimerCallback()
								{									
								    public void onTimePassed(final TimerHandler pTimerHandler)
								    {
								    	...
								    	SceneManager.getInstance().loadGame3Scene(engine);
								    }
								}));
					...
					levelObject = new Sprite(x, y, resourcesManager.complete_stars_region, vbom)
					{
						...
						protected void onManagedUpdate(float pSecondsElapsed) 
						{
							...
							if (player.collidesWith(this))
							{
								...
								SceneManager.getInstance().loadGame4Scene(engine);
