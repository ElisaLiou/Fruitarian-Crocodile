 ...
 * @version 1.0
 */
public class Game2Scene extends BaseScene implements IOnMenuItemClickListener
{
...
// createPhysics() causes application termination!!!
	...
	private void createGameChildScene()
	{
		...
		final IMenuItem BOLLONItem = new ScaleMenuItemDecorator(new SpriteMenuItem(BOLLON, resourcesManager.bollon_region, vbom), 1.3f, 1);
					...
					levelObject = new Sprite(x, y, resourcesManager.complete_stars_region, vbom)
					{
						...
						protected void onManagedUpdate(float pSecondsElapsed) 
						{
							...
							if (player.collidesWith(this))
							{
								...
								levelCompleteWindow.display(StarsCount.THREE, Game2Scene.this, camera);
								this.setVisible(false);
								this.setIgnoreUpdate(true);
