 ...
 * @version 1.0
 */
public class Game4Scene extends BaseScene implements IOnMenuItemClickListener
{
	...
	private final int BOLLON = 1;
	private final int ROPE2 = 2;
	private static final Object TAG_ENTITY_ATTRIBUTE_TYPE_VALUE_PLATFORM1 = "platform1";
	private static final Object TAG_ENTITY_ATTRIBUTE_TYPE_VALUE_PLATFORM2 = "platform2";
	private static final Object TAG_ENTITY_ATTRIBUTE_TYPE_VALUE_PLATFORM3 = "platform3";
	private static final Object TAG_ENTITY_ATTRIBUTE_TYPE_VALUE_ROPE = "rope";
	...
	SpriteMenuItem rope;
	SpriteMenuItem bollon;
	SpriteMenuItem rope2;
	SpriteMenuItem playerbtn;
...
// createPhysics() causes application termination!!!
	...
	public boolean onMenuItemClicked(MenuScene pMenuScene, IMenuItem pMenuItem, float pMenuItemLocalX, float pMenuItemLocalY)
	{
		switch(pMenuItem.getID())
		{
			...
			case ROPE2:
				...
				return true;	
            case BOLLON:
				//if((player.getY()<=295)&&(player.getY()>=305))
            	ResourcesManager.getInstance().Bollon.play();
	...
	private void createGameChildScene()
	{
		...
		rope2=new SpriteMenuItem(ROPE2, resourcesManager.rope_region, vbom);
		final IMenuItem ROPE2Item = new ScaleMenuItemDecorator(rope2, 1f, 1);
		rope2.setVisible(false);
		bollon= new SpriteMenuItem(BOLLON, resourcesManager.bollon_region, vbom); 
		final IMenuItem BOLLONItem = new ScaleMenuItemDecorator(bollon, 1f, 1);
	
		
		menuChildScene.addMenuItem(ROPEItem);
		menuChildScene.addMenuItem(ROPE2Item);
		menuChildScene.addMenuItem(BOLLONItem);
...
//		playMenuItem.setPosition(playMenuItem.getX(), playMenuItem.getY() + 10);
		ROPEItem.setPosition(-55, ROPEItem.getY()-60);
		
		ROPE2Item.setPosition(-180, ROPE2Item.getY()+60);
		
		
		BOLLONItem.setPosition(40,300);
					...
					levelObject = new Sprite(x, y, resourcesManager.complete_stars_region, vbom)
					{
						...
						protected void onManagedUpdate(float pSecondsElapsed) 
						{
							...
							if (player.collidesWith(this))
							{
								...
								levelCompleteWindow.display(StarsCount.THREE, Game4Scene.this, camera);
								this.setVisible(false);
								this.setIgnoreUpdate(true);
